...
function NewsFeed()
{
    ...
    foreach($Projects as $key) {
        $Object=new Feed($key->getMaterie(),$key->getPosttime()->format('Y-m-d H:i:s'),"Project",$key->getDuetime()->format('Y-m-d'));
        array_push($NewsFeed,$Object);
    }
    foreach($Tests as $key){
        $Object=new Feed($key->getMaterie(),$key->getPosttime()->format('Y-m-d H:i:s'),"Test",$key->getDuetime()->format('Y-m-d'));
        array_push($NewsFeed,$Object);
    }*/
