...
class HomeworkTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'CourseId', 'Materie', 'Duetime', 'Posttime', 'Nota', ),
        self::TYPE_CAMELNAME     => array('id', 'courseId', 'materie', 'duetime', 'posttime', 'nota', ),
        self::TYPE_COLNAME       => array(HomeworkTableMap::COL_ID, HomeworkTableMap::COL_COURSE_ID, HomeworkTableMap::COL_MATERIE, HomeworkTableMap::COL_DUETIME, HomeworkTableMap::COL_POSTTIME, HomeworkTableMap::COL_NOTA, ),
        self::TYPE_FIELDNAME     => array('id', 'course_id', 'Materie', 'DueTime', 'PostTime', 'Nota', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'CourseId' => 1, 'Materie' => 2, 'Duetime' => 3, 'Posttime' => 4, 'Nota' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'courseId' => 1, 'materie' => 2, 'duetime' => 3, 'posttime' => 4, 'nota' => 5, ),
        self::TYPE_COLNAME       => array(HomeworkTableMap::COL_ID => 0, HomeworkTableMap::COL_COURSE_ID => 1, HomeworkTableMap::COL_MATERIE => 2, HomeworkTableMap::COL_DUETIME => 3, HomeworkTableMap::COL_POSTTIME => 4, HomeworkTableMap::COL_NOTA => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'course_id' => 1, 'Materie' => 2, 'DueTime' => 3, 'PostTime' => 4, 'Nota' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
