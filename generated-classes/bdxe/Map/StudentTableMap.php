...
use bdxe\Student;
use bdxe\StudentQuery;


/**
 * This class defines the structure of the 'student_tb' table.
 *
 *
 *
...
class StudentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'bdxe.Map.StudentTableMap';
     ...
     */
    const TABLE_NAME = 'student_tb';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\bdxe\\Student';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'bdxe.Student';
     ...
     */
    const COL_ID = 'student_tb.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'student_tb.name';

    /**
     * the column name for the email field
     */
    const COL_EMAIL = 'student_tb.email';

    /**
     * the column name for the password field
     */
    const COL_PASSWORD = 'student_tb.password';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(StudentTableMap::COL_ID, StudentTableMap::COL_NAME, StudentTableMap::COL_EMAIL, StudentTableMap::COL_PASSWORD, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(StudentTableMap::COL_ID => 0, StudentTableMap::COL_NAME => 1, StudentTableMap::COL_EMAIL => 2, StudentTableMap::COL_PASSWORD => 3, ),
    ...
    {
        // attributes
        $this->setName('student_tb');
        $this->setPhpName('Student');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\bdxe\\Student');
        $this->setPackage('bdxe');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('student_tb_SEQ');
        // columns
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(StudentTableMap::COL_PASSWORD);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \bdxe\Student) { // it's a model object
