...
class ProjectTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'CourseId', 'Titlu', 'Materie', 'Dificultate', 'Nota', 'NumarParticipanti', 'Duetime', 'Posttime', ),
        self::TYPE_CAMELNAME     => array('id', 'courseId', 'titlu', 'materie', 'dificultate', 'nota', 'numarParticipanti', 'duetime', 'posttime', ),
        self::TYPE_COLNAME       => array(ProjectTableMap::COL_ID, ProjectTableMap::COL_COURSE_ID, ProjectTableMap::COL_TITLU, ProjectTableMap::COL_MATERIE, ProjectTableMap::COL_DIFICULTATE, ProjectTableMap::COL_NOTA, ProjectTableMap::COL_NUMAR_PARTICIPANTI, ProjectTableMap::COL_DUETIME, ProjectTableMap::COL_POSTTIME, ),
        self::TYPE_FIELDNAME     => array('id', 'course_id', 'Titlu', 'Materie', 'Dificultate', 'Nota', 'Numar_Participanti', 'DueTime', 'PostTime', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'CourseId' => 1, 'Titlu' => 2, 'Materie' => 3, 'Dificultate' => 4, 'Nota' => 5, 'NumarParticipanti' => 6, 'Duetime' => 7, 'Posttime' => 8, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'courseId' => 1, 'titlu' => 2, 'materie' => 3, 'dificultate' => 4, 'nota' => 5, 'numarParticipanti' => 6, 'duetime' => 7, 'posttime' => 8, ),
        self::TYPE_COLNAME       => array(ProjectTableMap::COL_ID => 0, ProjectTableMap::COL_COURSE_ID => 1, ProjectTableMap::COL_TITLU => 2, ProjectTableMap::COL_MATERIE => 3, ProjectTableMap::COL_DIFICULTATE => 4, ProjectTableMap::COL_NOTA => 5, ProjectTableMap::COL_NUMAR_PARTICIPANTI => 6, ProjectTableMap::COL_DUETIME => 7, ProjectTableMap::COL_POSTTIME => 8, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'course_id' => 1, 'Titlu' => 2, 'Materie' => 3, 'Dificultate' => 4, 'Nota' => 5, 'Numar_Participanti' => 6, 'DueTime' => 7, 'PostTime' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
