...
abstract class Homework implements ActiveRecordInterface 
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : HomeworkTableMap::translateFieldName('Posttime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->posttime = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : HomeworkTableMap::translateFieldName('Nota', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = HomeworkTableMap::NUM_HYDRATE_COLUMNS.
