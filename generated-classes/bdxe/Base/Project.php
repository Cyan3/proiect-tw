...
abstract class Project implements ActiveRecordInterface 
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ProjectTableMap::translateFieldName('Nota', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nota = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ProjectTableMap::translateFieldName('NumarParticipanti', TableMap::TYPE_PHPNAME, $indexType)];
            $this->numar_participanti = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ProjectTableMap::translateFieldName('Duetime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->duetime = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ProjectTableMap::translateFieldName('Posttime', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 9; // 9 = ProjectTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[5] => $this->getNota(),
            $keys[6] => $this->getNumarParticipanti(),
            $keys[7] => $this->getDuetime(),
            $keys[8] => $this->getPosttime(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) {
            $this->setNumarParticipanti($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setDuetime($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setPosttime($arr[$keys[8]]);
        }
    }
