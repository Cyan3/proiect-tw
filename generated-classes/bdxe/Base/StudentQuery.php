 ...
 *
 * @method     \bdxe\SubscriptionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class StudentQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, name, email, password FROM student_tb WHERE id = :p0';
        try {
