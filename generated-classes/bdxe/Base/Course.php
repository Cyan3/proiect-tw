...
abstract class Course implements ActiveRecordInterface 
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CourseTableMap::translateFieldName('StartDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->start_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CourseTableMap::translateFieldName('FinishDate', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = CourseTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function clear()
    {
        ...
        if (null !== $this->aSubject) {
            $this->aSubject->removeCourse($this);
        }
        $this->id = null;
