	...
	if(!isset($_SESSION['AssigmentMessage']))
{
	...
	if(isset($_SESSION['user']) && $_SESSION['type']=="Profesor")
	{
		echo "Succes";
			...
			{
				if(!isEmpty($_POST['Materie'])&&!isEmpty($_POST['Size'])&&!isEmpty($_POST['Dificultate'])&&!isEmpty($_POST['Title'])&&!isEmpty($_POST['DueTime']))
					{
						InsertIntoAssigments($_POST['Materie'],$_POST['Size'],$_POST['Dificultate'],$_POST['Title'],$_POST['DueTime']);
						$_SESSION['AssigmentMessage']="<br>Assigment Added!<br>";
						header("Location: Profesor.php");
					}
				else
					echo "Nu au fost completate toate fieldurile";
			}
	}
		else
...
function InsertIntoAssigments($Subject,$Size,$Dificulty,$Title,$DueTime)
{
